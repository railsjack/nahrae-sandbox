jQuery(document).ready(function(r) {
    ...
    function e(t) {
        ...
        t.closest("label").hover(function() {
            var t, e, a = r(this).find("input"), i = a.prop("disabled");
            o && (t = r(this),
            e = i,
    ...
    r.material = {
        ...
        input: function(t) {
            r(t || this.options.inputElements).filter(":notmdproc").data("mdproc", !0).each(function() {
                ...
                if (0 !== i.length || "hidden" === a.attr("type") || a.attr("hidden") || a.parents(".pirate_forms").length || (a.wrap('<div class="form-group"></div>'),
                i = a.closest(".form-group")),
                ...
                a.attr("data-hint") && (a.after('<p class="help-block">' + a.attr("data-hint") + "</p>"),
                a.removeAttr("data-hint"));
                if (r.each({
                    "input-lg": "form-group-lg",
                    "input-sm": "form-group-sm"
                }, function(t, e) {
                    a.hasClass(t) && (a.removeClass(t),
                    i.addClass(e))
                }),
                ...
                null !== a.val() && "undefined" !== a.val() && "" !== a.val() || i.addClass("is-empty"),
                0 < i.find("input[type=file]").length && i.addClass("is-fileinput")
            })
        },
        ...
        init: function(t) {
            ...
            document.arrive && this.options.arrive && (r.fn.ripples && this.options.ripples && e.arrive(this.options.withRipples, function() {
...
function(l) {
    ...
    l.hestia = {
        ...
        fixHeaderPadding: function() {
            ...
            if (l("#wpadminbar").length && e.matches ? (l(".wrapper.classic-blog").find(".main").css("margin-top", t - 46),
            l(".carousel .item .container").css("padding-top", t + 50 - 46),
            l(".home.page.page-template-default .navbar").hasClass("no-slider") && l(".home.page.page-template-default .main").css("margin-top", t - 46)) : (l(".wrapper.classic-blog").find(".main").css("margin-top", t),
        ...
        initCarouselSwipe: function() {
            if ("undefined" != typeof Hammer) {
                var t = "swipeleft"
                  , e = "swiperight";
                if (0 !== l("body.rtl").length && (t = "swiperight",
                e = "swipeleft"),
        ...
        scrollToTop: function() {
            ...
            l(window).on("scroll", function() {
                ...
                e < t && 0 === a && (l(".hestia-scroll-to-top").addClass("hestia-fade"),
                a = 1),
                t < e && 1 === a && (l(".hestia-scroll-to-top").removeClass("hestia-fade"),
                a = 0)
            }),
        ...
        setControlLabel: function() {
            ...
            if (void 0 !== a) {
                ...
                "" === l(i).attr("value") ? l(a).addClass("label-floating is-empty") : l(a).addClass("label-floating"),
                l.utilitiesFunctions.addControlLabel(i)
            }
            void 0 !== l(".contact_submit_wrap") && l(".pirate-forms-submit-button").addClass("btn btn-primary"),
            void 0 !== l(".form_captcha_wrap") && (l(".form_captcha_wrap").hasClass("col-sm-4") && l(".form_captcha_wrap").removeClass("col-sm-6"),
            ...
            void 0 !== l("input") && (void 0 !== l('input[type="text"]') && l('input[type="text"]').addClass("form-control"),
            ...
            void 0 !== l(".form-control") && (l(".form-control").parent().addClass("form-group"),
            l(window).on("scroll", function() {
    ...
    l.navigation = {
        ...
        handleTouchDropdowns: function() {
            ...
            return l(".caret-wrap").on("touchstart", function(t) {
                ...
                l(e).hasClass("dropdown-submenu") && (l(e).siblings().removeClass("open").find("dropdown-submenu").removeClass("open"),
        ...
        toggleNavbarTransparency: function() { 
            ...
            if (0 !== t.length) {
                var e = !0
                  , a = l('.hestia-features').offset().top-50
                  , b = l('.hestia-about').offset().top-50;
            ...
            l('.navbar a[href*="#"], a.btn[href*="#"]').click(function() {
                ...
                if (location.pathname.replace(/^\//, "") === this.pathname.replace(/^\//, "") && location.hostname === this.hostname) {
                    ...
                    if ((t = t.length ? t : l("[name=" + this.hash.slice(1) + "]")).length)
                        ...
                        l("body").hasClass("menu-open") && (l("body").removeClass("menu-open"),
